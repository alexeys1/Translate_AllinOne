...
public final class ScoreboardEntryTemplate {
    ...
    public record Prepared(
        ...
        public Prepared {
            original = original == null ? Text.empty() : original.copy();
        }

        public Text renderOriginal() {
            return original.copy();
        }

        public Text renderTranslated(ComponentTranslationResponse response) {
            if (document == null) {
                throw new IllegalStateException("Scoreboard Text document is unavailable.");
            }
            Text translated = APPLIER.apply(document, response);
    ...
    public static Prepared prepare(
        ...
        Text original = prepareComponentSource(copyOrEmpty(prefix), copyOrEmpty(owner), copyOrEmpty(suffix));
    ...
    private static Text prepareComponentSource(Text prefix, Text owner, Text suffix) {
