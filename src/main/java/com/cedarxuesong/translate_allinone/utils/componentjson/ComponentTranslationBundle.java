...
public record ComponentTranslationBundle(
    ...
    public static ComponentTranslationBundle create(
        ...
        for (Text text : components) {
            templates.add(ComponentDynamicTemplate.prepare(text));
        }
    ...
    public static ComponentTranslationBundle createCoherentParagraph(
        ...
        for (Text text : components) {
            if (text == null) {
                throw new IllegalArgumentException("Coherent paragraph contains a null Text.");
            }
            templates.add(ComponentDynamicTemplate.prepare(text));
        }
    ...
    public List<Text> apply(ComponentTranslationResponse response) {
