...
public final class ComponentTranslationJsonApplier {
    private final ComponentTranslationValidator validator;

    public ComponentTranslationJsonApplier() {
        this(new ComponentTranslationValidator());
    }

    public ComponentTranslationJsonApplier(ComponentTranslationValidator validator) {
        this.validator = validator == null ? new ComponentTranslationValidator() : validator;
    }

    public JsonElement apply(
